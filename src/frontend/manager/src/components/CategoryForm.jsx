...
export default function CategoryForm({ category = null, parentCategoryId = null, onCategorySaved, onCloseForm = null }) {
        ...
        <Paper className="category-form">
            <form onSubmit={handleSubmit(onSubmit)} className="category-form__body">
                ...
                <TextField
                    ...
                    helperText={errors.categoryName && errors.categoryName.type === 'required' ? 'Die Kategorie benötigt einen Namen' : ''}
                    required

        ...
        <Paper className="task-form">
            <form onSubmit={handleSubmit(onSubmit)} className="task-form__body">
                ...
                <TextField
                    ...
                    helperText={errors.title && errors.title.type === 'required' ? 'Die Aufgabe benötigt einen Titel' : ''}
                    required
                />
                <TextField
                    id="description"
                ...
                <div className="task-form__dates">
                    ...
                    <Autocomplete
                        ...
                        renderInput={params => <TextField {...params} label="Wiederhungen" variant="outlined" />}
                        value={frequency}
